...
2. The federation dispatches it to each model.
3. Each model answers independently.
4. The governance layer labels, flags, and annotates.
5. The user receives a side-by-side lattice of epistemically structured outputs.
...
### **6.5 Zero-Touch Convergence** *(NEW)*
